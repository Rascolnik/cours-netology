...
print(f"Порядок курсов по длительности: {', '.join(courses_list[id]['title'] for id in indexes_d)}")
print(f"Порядок курсов по количеству преподавателей: {', '.join(courses_list[ids]['title'] for ids in indexes_m)}")