...
for course in courses_list:
    ...
    names_surmame = course["mentors"]

    unique_names = []

    for names in names_surmame:
        name = names.split(" ")[0]
        unique_names.append(name)
    unique_name = set(unique_names)
    name_sorted = sorted(unique_name)
